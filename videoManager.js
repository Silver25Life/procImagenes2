...
const VideoManager = {
	...
	loadVideos: function() {
		this.videos = {
			...
			'marruecos': ['W2NMdtbgocY'],
			'nuevaZelanda': ['0iFtX2oMeC0'],
			'paraguay': ['Bz9AjSJOQDY'],
			'senegal': ['DqvtwMCRA68'],
			'sudafrica': ['2zlLX8ys-PA'],
			'tunez': ['ByzqZo9c-Ek'],
			'uruguay': ['5mvpS-yvij0'],
			'uzbekistan': ['uBf2NwpDinI']
		};
	},
